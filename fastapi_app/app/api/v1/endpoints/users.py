...
async def get_current_user_profile(
    ...
    if current_user.user_type == "candidate":
        ...
        if profile_orm:
            response_fields["candidate_profile"] = CandidateProfileResponse.model_validate(profile_orm)
        ...
        if profile_orm:
            response_fields["recruiter_profile"] = RecruiterProfileResponse.model_validate(profile_orm)
